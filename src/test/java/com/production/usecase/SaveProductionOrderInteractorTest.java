...
public class SaveProductionOrderInteractorTest {

    @Test
    public void testSaveProductionOrder() {
        ProductionOrderGateway productionOrderGateway = mock(ProductionOrderGateway.class);
        SaveProductionOrderInteractor interactor = new SaveProductionOrderInteractor(productionOrderGateway);
        ...
        Order savedOrder = interactor.saveProductionOrder(order);
        verify(productionOrderGateway).saveProductionOrder(order);
